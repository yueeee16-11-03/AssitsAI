...
const styles = StyleSheet.create({
  ...
  summaryAmount: { fontSize: 32, fontWeight: "900", color: "#fff", marginBottom: 16, textAlign: "center" },
  ...
  goalProgressFill: { height: "100%", backgroundColor: "#6366F1", borderRadius: 4 },
  ...
  contributorName: { fontSize: 14, fontWeight: "700", color: "#fff" },
  ...
  amountValue: { fontSize: 13, fontWeight: "700", color: "#fff" },
  goalActions: { flexDirection: "row", gap: 8 },
  actionBtn: { flex: 1, backgroundColor: "#6366F1", borderRadius: 10, paddingVertical: 10, alignItems: "center" },
