...
const styles = StyleSheet.create({
  ...
  memberName: { fontSize: 24, fontWeight: "900", color: "#fff", marginBottom: 4 },
  ...
  categoryName: { fontSize: 14, fontWeight: "700", color: "#fff" },
  ...
  transInfo: { flex: 1 },
  transCategory: { fontSize: 14, fontWeight: "700", color: "#fff", marginBottom: 2 },
  ...
  goalInfo: { flex: 1 },
  goalName: { fontSize: 16, fontWeight: "800", color: "#fff", marginBottom: 4 },
