...
const styles = StyleSheet.create({
  ...
  recTitle: { fontSize: 16, fontWeight: "800", color: "#fff", marginBottom: 8 },
  recDescription: { fontSize: 13, color: "rgba(255,255,255,0.7)", lineHeight: 18, marginBottom: 12 },
  recFooter: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  benefitContainer: { flex: 1 },
  benefitLabel: { fontSize: 11, color: "rgba(255,255,255,0.5)", marginBottom: 2 },
  benefitValue: { fontSize: 14, fontWeight: "700", color: "#fff" },
  actionButton: {
  ...
  completedTitle: { fontSize: 14, fontWeight: "700", color: "rgba(255,255,255,0.8)", marginBottom: 2 },
  completedBenefit: { fontSize: 12, color: "rgba(255,255,255,0.6)" },
  askAIButton: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "center",
