...
const styles = StyleSheet.create({
  ...
  tabSelector: { flexDirection: "row", backgroundColor: "rgba(255,255,255,0.04)", margin: 16, borderRadius: 12, padding: 4 },
  ...
  notificationCard: { flexDirection: "row", backgroundColor: "rgba(255,255,255,0.04)", borderRadius: 16, padding: 16, marginBottom: 12, borderLeftWidth: 3, borderLeftColor: "transparent" },
  ...
  notificationTitle: { flex: 1, fontSize: 16, fontWeight: "800", color: "#fff", marginRight: 8 },
  notificationTime: { fontSize: 12, color: "rgba(255,255,255,0.5)" },
  notificationMessage: { fontSize: 14, color: "rgba(255,255,255,0.8)", lineHeight: 20, marginBottom: 8 },
  notificationFooter: { flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  typeBadge: { borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4 },
  typeBadgeText: { fontSize: 11, fontWeight: "700" },
  actionHint: { fontSize: 12, color: "rgba(255,255,255,0.5)", fontWeight: "600" },
});
