...
const styles = StyleSheet.create({
  ...
  featureTitle: { fontSize: 14, fontWeight: "700", color: "#fff", marginBottom: 4, textAlign: "center" },
  ...
  teamInfo: { flex: 1 },
  teamRole: { fontSize: 14, fontWeight: "700", color: "#fff", marginBottom: 2 },
  ...
  linkInfo: { flex: 1 },
  linkTitle: { fontSize: 16, fontWeight: "700", color: "#fff", marginBottom: 2 },
