...
const styles = StyleSheet.create({
  ...
  scoreTitle: { fontSize: 18, fontWeight: "800", color: "#fff" },
  ...
  scoreValue: { fontSize: 56, fontWeight: "900", color: "#fff" },
  ...
  insightTitle: { fontSize: 16, fontWeight: "800", color: "#fff", marginBottom: 6 },
  ...
  insightButtonText: { color: "#fff", fontWeight: "700", fontSize: 13 },
  ...
  reminderHabit: { fontSize: 16, fontWeight: "800", color: "#fff", marginBottom: 4 },
  ...
  reminderToggleCircle: { width: 28, height: 28, borderRadius: 14, backgroundColor: "#fff" },
